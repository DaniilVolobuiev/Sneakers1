...
const Navbar = (props) => {
  ...
  const onClickCartMod = () => {
    props.onClickCart();
    props.setBurgerOpened();
  };
  return (
    <nav>
      <Link to="/">
        <div className="navLeft">
          ...
          <div className="navInfo">
            ...
            <p>The best leg shop ever</p>
          </div>
        </div>
      </Link>
      <div className="navRightWrapper">
        <div className="menuBurgerWrapper">
          <div onClick={props.onOpenBurger} className="menuBurgerIcon">
            <span></span>
          </div>
        </div>
        {props.burgerOpened ? (
